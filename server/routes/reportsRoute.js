...
router.get('/get-reports', authMiddleware, async (req, res) => {
    try {
        ...
        const availableBookCopiesCount = books.reduce((acc, book) => {
            return acc + book.availableCopies;
        }, 0);
        const issuedBookCopiesCount = totalBooksCopiesCount - availableBookCopiesCount;
        ...
        res.send({
            ...
            data: {
                books: {
                    ...
                    availableBookCopiesCount,
                    issuedBookCopiesCount,
                },
                users: {
                    usersCount,
                    patronsCount,
